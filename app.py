...
def display_recipe_image(recipe_name):
    ...
    # PIXABAY API
    url = f"https://pixabay.com/api/?key={api_key}&q={query}&image_type=photo&orientation=horizontal&per_page=3"
    try:
...
#%% model
system_prompt = """You are a recipe assistant. You are given the name of a dish and you have to return the recipe name, ingredients and steps in JSON format following this template : {{"recipe_name": "...", "ingredients": [{{"name": "...", "quantity": ...}}], "steps": []}}."""
